...
const spices = [
  {
    name: "Chaat Masala",
    description:
      "Chaat Masala is a tangy, spicy, and flavorful blend of spices that instantly enhances the taste of any snack or dish. It is made from dried mango powder (amchur), cumin, coriander, black salt, and a variety of other aromatic spices. The unique sourness and slight pungency of chaat masala make it a favorite for street food lovers in India. It is sprinkled on fruits, salads, chaats, pakoras, sandwiches, and even beverages like lemonade to give them a zesty punch. Apart from taste, it aids digestion and stimulates appetite. No Indian pantry is complete without this versatile spice mix.",
    highlights: [
      "Flavor Profile: Tangy, sour, slightly pungent",
      "Best Used In: Fruits, salads, chaats, pakoras, lemonade",
      "Health Benefit: Aids digestion and stimulates appetite",
    ],
  },
  {
    name: "Garam Masala",
    description:
      "Garam Masala is one of the most essential spice blends in Indian cooking, often referred to as the 'soul of Indian curries.' It is a warming mix of ground spices such as black pepper, cinnamon, cardamom, cloves, cumin, and nutmeg. The term 'garam' means heat, not in terms of spiciness but the warmth it provides to the body. Garam masala is typically added towards the end of cooking to retain its aroma and depth of flavor. It enhances the richness of curries, dals, rice dishes, and even marinades. Its fragrant profile is what gives Indian cuisine its authentic character.",
    highlights: [
      "Flavor Profile: Warm, aromatic, slightly sweet",
      "Best Used In: Curries, dals, rice dishes, marinades",
      "Health Benefit: Boosts metabolism and improves digestion",
    ],
  },
  {
    name: "Meat Masala",
    description:
      "Meat Masala is a robust spice mix crafted to bring out the best flavors in non-vegetarian dishes. It combines spices like cumin, coriander, black pepper, cloves, cinnamon, and red chilies, offering a balance of heat and aroma. This masala is specifically designed to enhance mutton, chicken, and other meat preparations, making them rich, flavorful, and restaurant-style. It adds thickness to gravies and intensifies the taste of marinades. Whether you are preparing a spicy curry, a dry fry, or a slow-cooked dish, meat masala is the perfect choice for an authentic Indian meat delicacy.",
    highlights: [
      "Flavor Profile: Bold, spicy, aromatic",
      "Best Used In: Chicken curry, mutton curry, marinades",
      "Health Benefit: Improves digestion with warming spices",
    ],
  },
  {
...
const Products = () => {
  ...
  return (
    <section className="products-section">
      <h1 className="products-heading">Our Spice Collection</h1>

      <div className="spices">
        {spices.slice()
        .sort(() => Math.random() - 0.5).map((spice, index) => (
          <div key={index}
          ...
          >
            ...
            <div className="details">
              ...
              <ul className="spice-highlights">
                {spice.highlights.map((point, i) => (
                  <li key={i}>{point}</li>
                ))}
              </ul>
            </div>
      ...
      {/* {selected && (
        <div className="spice-modal">
          <div className="spice-modal-content">
            <button
              className="close-btn"
            ...
            <img src={`/assets/images/spices/${selected.name}.png`} alt={selected.name} />
            <h2>{selected.name}</h2>
